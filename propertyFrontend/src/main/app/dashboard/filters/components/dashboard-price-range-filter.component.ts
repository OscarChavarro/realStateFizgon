...
@Component({
  selector: 'app-dashboard-price-range-filter',
  standalone: true,
  templateUrl: './dashboard-price-range-filter.component.html',
  styleUrl: './dashboard-price-range-filter.component.css'
})
export class DashboardPriceRangeFilterComponent implements OnInit, OnChanges {
  ...
  private async loadPriceRange(): Promise<void> {
    if (DashboardPriceRangeFilterComponent.cachedPriceRange) {
      this.applyPriceRange(DashboardPriceRangeFilterComponent.cachedPriceRange);
      return;
    }
    ...
    try {
      ...
      DashboardPriceRangeFilterComponent.cachedPriceRange = range;
