...
@Component({
  selector: 'app-dashboard-pagination-controls',
  standalone: true,
  templateUrl: './dashboard-pagination-controls.component.html',
  styleUrl: './dashboard-pagination-controls.component.css'
})
export class DashboardPaginationControlsComponent {
