...
export class Configuration {
  ...
  constructor() {
    ...
    this.environment = this.parseWithSchema(EnvironmentSchema, environmentPayload, environmentPath);
    ...
    this.secrets = this.parseWithSchema(SecretsSchema, secretsPayload, secretsPath);
