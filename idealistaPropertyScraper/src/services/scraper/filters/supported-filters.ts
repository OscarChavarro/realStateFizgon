...
import { Bathrooms } from 'src/model/filters/bathrooms.filter';
import { Condition } from 'src/model/filters/condition.filter';
import { EnergyEfficiency } from 'src/model/filters/energy-efficiency.filter';
import { Equipment } from 'src/model/filters/equipment.filter';
import { Features } from 'src/model/filters/features.filter';
import { Floor } from 'src/model/filters/floor.filter';
import { HousingType } from 'src/model/filters/housing-type.filter';
import { ListingType } from 'src/model/filters/listing-type.filter';
import { Multimedia } from 'src/model/filters/multimedia.filter';
import { OtherDenominations } from 'src/model/filters/other-denominations.filter';
import { Price } from 'src/model/filters/price.filter';
import { PropertyType } from 'src/model/filters/property-type.filter';
import { PublicationDate } from 'src/model/filters/publication-date.filter';
import { RentalType } from 'src/model/filters/rental-type.filter';
import { Rooms } from 'src/model/filters/rooms.filter';
import { Size } from 'src/model/filters/size.filter';
